  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience the ease of tool rental with Construction Tool Rental - Your one-stop solution for accessing quality construction tools from multiple outlets."
        />
      </Head>
      <HomeLayout>
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience the ease of tool rental with Construction Tool Rental - Your one-stop solution for accessing quality construction tools from multiple outlets.`}
            </Text>
            <Box
